    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-muted p-4 relative">
      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl md:text-5xl font-bold text-primary app-name">REFUUG</h1>
        ...
        <div className="text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} <span className="app-name">REFUUG</span>. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
